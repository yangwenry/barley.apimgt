...
* under the License.
*/
package barley.apimgt.usage.publisher.internal;
...
public class UsageComponent {
    ...
    public void setAPIManagerConfigurationService(APIManagerConfigurationService service) {
    ...
    public void unsetAPIManagerConfigurationService(APIManagerConfigurationService service) {
