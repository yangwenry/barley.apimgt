...
import barley.apimgt.usage.client.bean.RequestSearchBean;
...
import barley.apimgt.usage.client.bean.SearchRequestBean;
import barley.apimgt.usage.client.bean.TableExistResponseBean;
