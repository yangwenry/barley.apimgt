...
-- ALTER TABLE AM_API  ADD COLUMN CATEGORY VARCHAR(50);
-- ALTER TABLE AM_API  ADD COLUMN THUMBNAIL_URL VARCHAR(256);
-- ALTER TABLE AM_API  ADD COLUMN DESCRIPTION TEXT;

-- API_TIER 추가 
-- (2019.10.14) - TAG 테이블 추가
CREATE TABLE IF NOT EXISTS AM_API_TAG (
