...
-- (2019.09.26) UM_STATE VARCHAR(30) 추가 
...
# 기초데이터 생성 
insert into um_tenant(um_id, um_domain_name, um_email, um_active) values(-1234, 'carbon.super', 'wso2.system.user@carbon.super', 1);

# system user 생성 (확인이 필요함. 비번은 admin으로 세팅) 
INSERT INTO UM_USER (UM_USER_NAME, UM_USER_PASSWORD, UM_SALT_VALUE, UM_REQUIRE_CHANGE, UM_CHANGED_TIME, UM_TENANT_ID) 
 VALUES ('wso2.system.user', 'NYonc74Meyv12NjuBNs41C67fD1OPzEjeehvQTQVxRc=', 'Z1vlgpbXUrAXcXGA70vmMQ==', 0, date(), 0);
