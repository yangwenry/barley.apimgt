...
* under the License.
*/
package barley.apimgt.gateway.handlers.security.thrift;
...
import barley.apimgt.impl.generated.thrift.ConditionGroupDTO;
...
public class ThriftKeyValidatorClient {
    ...
    public APIKeyValidationInfoDTO getAPIKeyData(String context, String apiVersion, String apiKey,
        ...
        barley.apimgt.impl.generated.thrift.APIKeyValidationInfoDTO thriftDTO;
    ...
    public ArrayList<URITemplate> getAllURITemplates(String context, String apiVersion
        ...
        List<barley.apimgt.impl.generated.thrift.URITemplate> uriTemplates;
        ...
        for (barley.apimgt.impl.generated.thrift.URITemplate aDto : uriTemplates) {
    ...
    private URITemplate toTemplates(
    		barley.apimgt.impl.generated.thrift.URITemplate dto) {
        ...
        if (conditionGroupsThrift != null && !conditionGroupsThrift.isEmpty()) {
        	barley.apimgt.api.dto.ConditionGroupDTO[] conditionGroups = new barley.apimgt.api.dto
            ...
            for (short groupCounter = 0; groupCounter < conditionGroupsThrift.size(); groupCounter++) {
            	barley.apimgt.api.dto.ConditionGroupDTO conditionGroup = new barley.apimgt.api.dto
                        .ConditionGroupDTO();
                ...
                List<barley.apimgt.impl.generated.thrift.ConditionDTO> conditionsThrift = conditionGroupThrift
                        .getConditions();
                if (conditionsThrift != null && !conditionsThrift.isEmpty()) {
                    ...
                    for (short conditionCounter = 0; conditionCounter < conditionsThrift.size(); conditionCounter++) {
                        ...
                        barley.apimgt.impl.generated.thrift.ConditionDTO conditionThrift = conditionsThrift
