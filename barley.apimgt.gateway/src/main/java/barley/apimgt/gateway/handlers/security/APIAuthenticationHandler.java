...
import org.apache.synapse.metrics.MetricsConstants;
...
import barley.apimgt.gateway.handlers.security.oauth.OAuthAuthenticator;
...
//        Timer.Context context = timer.start();
    ...
    private String logMessageDetails(MessageContext messageContext) {
        ...
        // (임시주석) 2017.09.25 wso2 변수를 synapse 변수로 변경함. 
