    ...
    public boolean setScopes(OAuthTokenReqMessageContext tokReqMsgCtx) {
        ...
        try {
            ...
            restAPIScopesOfCurrentTenant = (Map)Caching.getCacheManager(APIConstants.API_MANAGER_CACHE_MANAGER)
                    ...
                    .get(tenantDomain);
            /*
            restAPIScopesOfCurrentTenant = Caching.getCachingProvider(RegistryConstants.CACHING_PROVIDER).getCacheManager()
                    .getCache("REST_API_SCOPE_CACHE", String.class, Map.class)
                    .get(tenantDomain);
            */
