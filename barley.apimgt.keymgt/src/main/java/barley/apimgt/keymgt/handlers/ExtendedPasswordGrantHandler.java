...
import barley.identity.application.common.cache.BaseCache;
...
public class ExtendedPasswordGrantHandler extends PasswordGrantHandler {
    ...
    private String getPrimaryFromSecondary(String login) {
        ...
        try {
            ...
            barley.user.core.UserStoreManager storeManager = realm.getUserStoreManager();
