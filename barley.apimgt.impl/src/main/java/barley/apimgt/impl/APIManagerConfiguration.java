        ...
        for (Iterator childElements = serverConfig.getChildElements(); childElements
            ...
            if (elementHasText(element)) {
                ...
                while (environmentIterator.hasNext()) {
                    ...
                    // (추가) 2017.12.20 - 포트로 인해 설정값 추가 
                    environment.setApiServiceEndpoint(APIUtil.replaceSystemProperty(
                            environmentElem.getFirstChildWithName(new QName(
                                    APIConstants.API_SERVICE_ENDPOINT)).getText()));
            ...
            if (throttleProperties.isEnabled()) {
                ...
                if (dataPublisher.isEnabled()) {
                    ...
                    if (receiverUrlGroupElement != null) {
                        dataPublisher.setReceiverUrlGroup(APIUtil.replaceSystemProperty(receiverUrlGroupElement
                                .getText()));
                    }
