...
public final class APIConstants {
    ...
    public static final String API_OVERVIEW_ENDPOINT_PASSWORD = "overview_endpointPassword";
    ...
    public static final String APPLICATION_QUOTA = "QUOTA";
    ...
    // (추가) 2017.12.20 - 포트추가로 인해 설정파일에 프로퍼티 추가 
    public static final String API_SERVICE_ENDPOINT = "ServiceEndpoint";
    ...
    // (추가) 2017.11.20 - api info key 캐시를 위해 추가함. 
    public static final String API_INFO_CACHE_NAME = "apiInfoCache";
    ...
    // (추가) 2018.02.12 - api keymanagement key 캐시를 위해 추가함. 
    public static final String REST_API_SCOPE_CACHE_NAME = "REST_API_SCOPE_CACHE";
