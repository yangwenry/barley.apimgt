...
*/
package barley.apimgt.impl.publishers;
...
public class WSO2APIPublisher implements APIPublisher {
    ...
    private MultipartEntity getMultipartEntity(API api,String externalPublisher, String action)
            throws barley.registry.api.RegistryException, IOException, UserStoreException, APIManagementException {
    ...
    private static String getFullRegistryIconUrl(String postfixUrl) {
        String proxyContext = BarleyUtils.getServerConfiguration().getFirstProperty("MgtProxyContextPath");
        ...
        String hostName = BarleyUtils.getServerConfiguration().getFirstProperty("HostName");
    ...
    private static String getBackendPort(String transport) {
        ...
        port = BarleyUtils.getTransportProxyPort(context, transport);
        if (port == -1) {
            port = BarleyUtils.getTransportPort(context, transport);
        }
