...
import barley.apimgt.impl.observers.CommonConfigDeployer;
import barley.apimgt.impl.observers.SignupObserver;
...
public class APIManagerComponent {
    ...
    public void activate() throws Exception {
        ...
        try {
            ...
            addRxtConfigs();
            addTierPolicies();
            // (임시주석) BarleyContext.getThreadLocalCarbonContext().getRegistry() 가 null을 리턴하므로 주석처리.
