...
public class ApplicationUtils {
    ...
    public static OAuthAppRequest createOauthAppRequest(String clientName, String clientId, String callbackURL,
    	...
    	return createOauthAppRequest(clientName, clientId, callbackURL, tokenScope, clientDetails, null);
    }
    
    public static OAuthAppRequest createOauthAppRequest(String clientName, String clientId, String callbackURL,
            String tokenScope, String clientDetails, String subscriberName)
            throws
            APIManagementException {
        ...
        // (추가) 2017.09.27
        if(subscriberName != null) authApplicationInfo.addParameter(ApplicationConstants.OAUTH_CLIENT_USERNAME, subscriberName);
