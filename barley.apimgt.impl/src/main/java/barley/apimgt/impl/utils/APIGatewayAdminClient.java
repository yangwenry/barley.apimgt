...
public class APIGatewayAdminClient extends AbstractAPIGatewayAdminClient {
    ...
    public APIGatewayAdminClient(APIIdentifier apiId, Environment environment) throws AxisFault {
        ...
        BarleyUtils.setBasicAccessSecurityHeaders(environment.getUserName(), environment.getPassword(),
     ...
     * @throws AxisFault
     */
    public org.wso2.carbon.apimgt.gateway.dto.stub.APIData getApi(String tenantDomain, APIIdentifier apiId) throws AxisFault {
        try {
        	org.wso2.carbon.apimgt.gateway.dto.stub.APIData apiData = null;
            if (tenantDomain != null && !("").equals(tenantDomain)
                && !MultitenantConstants.SUPER_TENANT_DOMAIN_NAME.equals(tenantDomain)) {
    ...
    public org.wso2.carbon.apimgt.gateway.dto.stub.APIData getDefaultApi(String tenantDomain, APIIdentifier apiId) throws AxisFault {
        try {
        	org.wso2.carbon.apimgt.gateway.dto.stub.APIData apiData = null;
            if (tenantDomain != null && !("").equals(tenantDomain)
                && !MultitenantConstants.SUPER_TENANT_DOMAIN_NAME.equals(tenantDomain)) {
